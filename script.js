...
const translations = {
    ...
    hu: {
        ...
        "hero.description": "Pataki Attila Bence vagyok, full-stack fejlesztő. Modern webes alkalmazásokat, automatizációkat és olyan digitális megoldásokat építek, amelyek valódi üzleti értéket teremtenek.",
        ...
        "hero.miniTitle": "Működő rendszereket építek",
        "hero.miniText": "Letisztult frontend, stabil backend logika és olyan automatizáció, ami valóban levesz a manuális terhekből.",
        "about.label": "Rólam",
        "about.title": "Több mint kód. Struktúrában, átláthatóságban és működő rendszerekben gondolkodom.", "about.description": "A célom nem csak weboldalak készítése, hanem olyan rendszerek tervezése, amelyek hatékonyak, skálázhatók és valódi helyzetekben is hasznosak. Kifejezetten érdekel a gyakorlatias webfejlesztés, az API-k, az automatizációk és minden olyan digitális megoldás, ami időt spórol és nem káoszt gyárt.",
        ...
        "projects.description": "Néhány projekt, ami jól mutatja, milyen irányban építkezem: automatizáció, gyakorlatias alkalmazások és valódi problémákra tervezett digitális rendszerek.", "projects.details": "Projekt részletei",
        "projects.card1.badge": "Full-Stack App",
        "projects.card1.title": "Coachtimize",
        ...
        "contact.title": "Építsünk valami letisztultat, hasznosat és valóban működőt.",
