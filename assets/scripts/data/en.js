export const en = {
  ...
  "currency.option.eur": "EUR - Euro",
  "currency.option.huf": "HUF - Hungarian forint",
  "site.logoLabel": "PAB homepage",
  ...
  "hero.description":
    "I'm Pataki Attila Bence, a full-stack developer building custom websites, web applications, AI automation, and API integrations for businesses with real operational problems.",
  ...
  "services.card1.title": "Custom Website Development",
  "services.card1.text":
    "Fast, responsive business and service websites with clear structure, understandable offers, and lead-focused contact paths.",
  "services.card2.title": "Custom Web Application Development",
  "services.card2.text":
    "Admin tools, client portals, dashboards, and backend logic that make daily operations easier to manage.",
  "services.card3.title": "AI Automation & API Integration",
  "services.card3.text":
    "Workflow automation, AI assistant-style processes, and API connections that reduce repetitive manual work.",
  "skills.label": "Skills",
  ...
  "contactPage.title": "Let's start a useful digital system.",
  "contactPage.lead":
    "If you need a custom website, web application, AI automation, or API integration, send me the short context of your project.",
  ...
  "project.links.contact": "Contact page",
  "project.links.projects": "Back to projects",
