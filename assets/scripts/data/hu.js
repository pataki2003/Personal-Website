export const hu = {
  ...
  "currency.option.eur": "EUR - euró",
  "currency.option.huf": "HUF - magyar forint",
  "site.logoLabel": "PAB kezdőlap",
  ...
  "hero.description":
    "Pataki Attila Bence vagyok, full-stack fejlesztő. Egyedi weboldalakat, webalkalmazásokat, AI automatizációkat és API-integrációkat építek vállalkozásoknak, valós üzleti problémákra.",
  ...
  "services.card1.title": "Egyedi weboldal készítés",
  "services.card1.text":
  ...
  "services.card2.title": "Egyedi webalkalmazás fejlesztés",
  "services.card2.text":
    "Admin felületek, ügyfélportálok, dashboardok és backend logikák, amelyek a napi működést átláthatóbbá és kezelhetőbbé teszik.",
  "services.card3.title": "AI automatizáció és API-integráció",
  "services.card3.text":
    "Folyamatautomatizálás, AI asszisztens jellegű workflow-k és API-kapcsolatok, amelyek csökkentik az ismétlődő manuális munkát.",
  ...
  "contactPage.title": "Indítsunk el egy hasznos digitális rendszert.",
  "contactPage.lead":
    "Ha egyedi weboldalra, webalkalmazásra, AI automatizációra vagy API-integrációra van szükséged, küldd el a projekt rövid kontextusát.",
  ...
  "project.links.contact": "Kapcsolat oldal",
  "project.links.projects": "Vissza a projektekhez",
